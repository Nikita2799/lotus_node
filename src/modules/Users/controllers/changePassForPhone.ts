...
export const changePassForPhone = async (req: Request, res: Response) => {
  try {
    ...
    const answer = await axios.get(
      `https://api.mobizon.ua/service/message/sendsmsmessage?recipient=${sortPhone}&text=${code}&apiKey=${config.security.API}`
    );
